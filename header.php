...
<meta name="google-site-verification" content="JwzLQeu_nXodSwIGi85ocuqwah4WFZp0qxPGgVUeO3s" />
  ...
  ================================================== -->
	...
	<!-- CSS
  ================================================== -->
<?php	//<link rel="stylesheet" href="<?php bloginfo('stylesheet_url'); end php tag here" type="text/css" />
 ...
 ?>
		<link rel="stylesheet" href="http://dadchartsstorage.blob.core.windows.net/notebookheavy/style.css">
		<link rel="stylesheet" href="http://dadchartsstorage.blob.core.windows.net/notebookheavy/skeleton-min.css">
		<link rel="stylesheet" href="http://dadchartsstorage.blob.core.windows.net/notebookheavy/layout-min.css">
