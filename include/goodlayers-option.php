		...
		'gdl_panel_page_style' => array(
			...
			__('SEARCH/ARCHIVE SIDEBAR', 'gdl_back_office')=>array(
				...
				'options'=>array(
					...
					'3'=>array('value'=>'no-sidebar','image'=>'/include/images/no-sidebar-120.png'))),
			__('SEARCH/ARCHIVE ITEM SIZE')=>array('name'=>THEME_SHORT_NAME.'_search_archive_size', 'type'=>'combobox','options'=>array('1/4','1/3','1/2','1/1'), 'default'=>'1/2'),
