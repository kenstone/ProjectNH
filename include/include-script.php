<?php
	...
	*/
	...
	function register_all_gdl_scripts(){
		...
		wp_register_script('jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js', '1.7.2', false);
		...
		if( $GLOBALS['pagenow'] != 'wp-login.php' ){
			if(is_admin()){
				...
				wp_enqueue_style('style-custom', 'http://dadchartsstorage.blob.core.windows.net/notebookheavy/style-custom-min.css');
	...
	*/ 
	...
	function register_non_admin_styles(){
		...
		wp_enqueue_style('superfish', 'http://dadchartsstorage.blob.core.windows.net/notebookheavy/superfish.css');
